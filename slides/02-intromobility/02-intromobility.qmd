...
> **For a child growing up in a low-income family here in San Antonio, how do the chances
> of moving up the income ladder compare with the rest of the country?**
...
\small This one is a **poll, not a quiz** --- you get credit for answering, and nothing is
taken off for guessing wrong. I want to see what the room thinks *before* we look at the data.
