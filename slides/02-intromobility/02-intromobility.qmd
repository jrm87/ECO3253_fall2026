...
>[Chetty, Friedman, Hendren, Jones, Porter. "The Opportunity Atlas: Mapping the Childhood Roots of Social Mobility" NBER WP, 2018](https://utsa.instructure.com/courses/79928/files/folder/papers?preview=13306202)
...
```{r fig_mob_chicago, fig.cap="Source: [Chetty, Hendren, Kline, Saez (QJE 2014)](https://academic.oup.com/qje/article/129/4/1553/1853754)", echo=FALSE, out.width = '80%'}
knitr::include_graphics("../../images/mob_chicago.png")
```

## Intergen. Mobility for Children Raised in Hypothetical Census Tract

```{r fig_mob_hyptract, fig.cap="Source: [Chetty, Hendren, Kline, Saez (QJE 2014)](https://academic.oup.com/qje/article/129/4/1553/1853754)", echo=FALSE, out.width = '70%'}
