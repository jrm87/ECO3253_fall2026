...
1. 15 minutes for regression analysis in R: see [https://jrm87.github.io/ECO3253_spring2026/regression.html](https://jrm87.github.io/ECO3253_spring2026/regression.html)
...
```{r fig_mob_better1, echo=FALSE, out.width = '65%'}
...
- Early research on MTO found little impact of moving to a better area on economic outcomes such as earnings
    ...
    - But it focused primarily on adults and older youth at point of move [e.g., [Kling, Liebman, and Katz (QJE 2007)](https://academic.oup.com/qje/article/122/1/83/1924719)]

- Motivated by quasi-experimental study ([Chetty and Hendren QJE 2018](https://academic.oup.com/qje/article/133/3/1107/4850660)), Chetty and co-authors test for exposure effects among children
...
- Housing vouchers can be very effective but must be targeted carefully
    ...
    2. Vouchers should be explicitly designed to help families move to affordable, high-opportunity areas
        ...
        - More generally, low-income families rarely use cash transfers to move to better neighborhoods [[Jacob, Kapustin, Ludwig (QJE 2015)](https://academic.oup.com/qje/article/130/1/465/2337966)]
...
> References: [CMTO summary](https://utsa.instructure.com/courses/79928/files/folder/papers?preview=13306205); [Bergman, Chetty, DeLuca, Hendren, Katz, Palmer "Creating Moves to Opportunity" (2019)](https://utsa.instructure.com/courses/79928/files/folder/papers?preview=13306208)
