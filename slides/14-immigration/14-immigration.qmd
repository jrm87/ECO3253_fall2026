...
> Slides based on those of [David Card (NBER Reporter 2009)](https://www.nber.org/reporter/2009number2/how-immigration-affects-us-cities); also see [Clemens "Economics and Emigration" JEP 2011](https://utsa.instructure.com/courses/79928/files/folder/papers?preview=13306222)
...
- [Lee, Peri and Yasenov (NBER WP 2017)](https://www.nber.org/papers/w23885) find no effect on 'native' employment, unemployment.
...
- [Abramitzky, Boustan, Jacome and Perez (AER 2021)](https://www.aeaweb.org/articles?id=10.1257/aer.20191586) use millions of father-son pairs across more than 100 years of US history
