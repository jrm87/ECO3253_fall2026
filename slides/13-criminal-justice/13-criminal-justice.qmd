...
- [Bertrand and Mullainathan (AER 2004)](https://utsa.instructure.com/courses/79928/files/folder/papers?preview=13306215) study biases in hiring by sending out fictitious resumes with identical credentials in response to real job ads
...
- [Kleinberg, Lakkaraju, Leskovec, Ludwig, Mullainathan (QJE 2018)](https://utsa.instructure.com/courses/79928/files/folder/papers?preview=13306220) compare the accuracy of human decisions and machine predictions in the criminal justice system
...
- [Kleinberg et al.](https://utsa.instructure.com/courses/79928/files/folder/papers?preview=13306220) compare machine learning predictions and judges' actual decisions in terms of performance in achieving this objective
...
*Source: [Kleinberg et al. (QJE 2018), Figure II](https://utsa.instructure.com/courses/79928/files/folder/papers?preview=13306220). Each dot is a 1000th-percentile bin of predicted risk.*
...
*Source: [Kleinberg et al. (QJE 2018), Figure V](https://utsa.instructure.com/courses/79928/files/folder/papers?preview=13306220).*
...
*Source: [Kleinberg et al. (QJE 2018), Tables VI and VII](https://utsa.instructure.com/courses/79928/files/folder/papers?preview=13306220).*
