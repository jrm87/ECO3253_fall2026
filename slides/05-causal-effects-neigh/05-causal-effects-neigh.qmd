...
```{r fig_mob_better2, echo=FALSE, out.width = '75%'}
knitr::include_graphics("../../images/mob_better2.png")
```

## Income Gain from Moving to a Better Neighborhood

```{r fig_mob_better3, echo=FALSE, out.width = '75%'}
knitr::include_graphics("../../images/mob_better3.png")
```

## Income Gain from Moving to a Better Neighborhood

```{r fig_mob_better4, echo=FALSE, out.width = '75%'}
knitr::include_graphics("../../images/mob_better4.png")
```

## Income Gain from Moving to a Better Neighborhood

```{r fig_mob_better5, echo=FALSE, out.width = '80%'}
...
```{r fig_mob_jobs, echo=FALSE, out.width = '80%'}
...
```{r fig_seg_atlanta, fig.cap="Source: [Dustin Cable, U. of Virginia Racial Dot Map (2013)](https://demographics.virginia.edu/DotMap/index.html), based on Census 2010", echo=FALSE, out.width = '60%'}
...
```{r fig_seg_sacramento, fig.cap="Source: [Dustin Cable, U. of Virginia Racial Dot Map (2013)](https://demographics.virginia.edu/DotMap/index.html), based on Census 2010", echo=FALSE, out.width = '60%'}
...
```{r fig_seg_sanantonio, fig.cap="Source: [Dustin Cable, U. of Virginia Racial Dot Map (2013)](https://demographics.virginia.edu/DotMap/index.html), based on Census 2010", echo=FALSE, out.width = '60%'}
...
5. Social Capital
    ...
    - [Putnam (1995): "Bowling Alone"](https://en.wikipedia.org/wiki/Bowling_Alone)

## New Map of Social Capital

Chetty and co-authors published a [Nature paper](https://www.nature.com/articles/s41586-022-04996-4) and a website exploring social capital across the US:

- [https://socialcapital.org/](https://socialcapital.org/)

## Check the correlation yourself

Go to the Section on [Simple and Multivariate Regression](https://jrm87.github.io/ECO3253_spring2026/regression.html) and check for yourself the correlation of `kfr_pooled_p25` and at least one of these: 
...
> Based on [Chetty, Hendren, Katz. "The Effects of Exposure to Better Neighborhoods on Children: New Evidence from the Moving to Opportunity Experiment" AER 2016](https://www.aeaweb.org/articles?id=10.1257/aer.20150572)
