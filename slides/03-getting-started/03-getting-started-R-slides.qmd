...
# Quiz: the Opportunity Atlas

## Today's quiz

Three questions on the non-technical summary of
[Chetty, Friedman, Hendren, Jones and Porter, *The Opportunity Atlas*](https://utsa.instructure.com/courses/92072/files/folder/papers?preview=15424717).
...
## Q1. What are the Opportunity Atlas data built from?

\small

**A.** Test scores from public school districts

**B.** Anonymized records for 20 million adults

**C.** Interviews with families in ten big cities

**D.** A yearly survey of 20,000 U.S. households

. . .

\vspace{0.3em}
**Answer: B.** Americans now in their mid-thirties, traced back to the Census tract they grew up in --- about 70,000 tracts.

## Q2. The Atlas finds that children's outcomes differ sharply...

\small

**A.** between cities, but rarely within a city

**B.** between states, but rarely within a state

**C.** between neighborhoods a mile or two apart

**D.** between the coasts and the rural interior

. . .

\vspace{0.3em}
**Answer: C.** Among black men from low-income families, 44% of those raised in Watts were incarcerated on Census day, against 6.2% in Compton --- 2.3 miles away.

## Q3. Atlanta and Charlotte had very high job and wage growth. Upward mobility there was...

\small

**A.** among the lowest rates in the country

**B.** very close to the national average

**C.** among the highest rates in the country

**D.** rising quickly, in step with job growth

. . .

\vspace{0.3em}
**Answer: A.** Those cities grew by attracting skilled workers from elsewhere. What predicts mobility is not being near jobs, but growing up around adults who have them.

## Poll: where are you with R?

Before we go further, I need to know where the room is.

\vspace{0.5em}

**A.** Downloaded **and** installed

**B.** Downloaded, but **not installed** yet

**C.** Something else --- not started, or stuck partway

\vspace{0.6em}

\small This one is a **poll, not a quiz** --- credit is for answering, and there is no wrong
answer. If you are in **B** or **C**, stay after class for two minutes and we will fix it.
...
## R and RStudio: on your own computer

To use R and RStudio, you can:

- **install both on your own computer** --- this is what we will do, and both are free
- or run them in a browser, on someone else's computer (the cloud)

\vspace{0.4em}
We will focus on the **local installation**, and that is what I will support in class. If you
would rather try a free **Posit Cloud** account, there are notes on the course site --- but it
is optional, and **there is no class invite this semester**.

# Let's open R!

## Let's open RStudio

Let's jump in! Open **RStudio** on your own laptop --- the copy you installed.

\vspace{0.4em}
Not installed yet? Follow the instructions on the course site, and for today sit next to
someone who has it running so you can follow along.
...
If you want to dive more and feel you could benefit from a more detailed introduction, check this short book: [Getting used to R, RStudio, and R Markdown](https://rbasics.netlify.app/) short book. 
...
## Project 0: what your PDF has to contain

You hand in **one PDF**, knitted from R Markdown, with five things:

\small

1. R code that computes the **square root of 12**
2. R code that loads the Project 1 data into a data frame called `atlas`
3. R code for the **mean and standard deviation** of average child income, for parents at the
   **25th** and **75th** percentiles
4. A **`ggplot`** showing the distribution of those variables across the **US, Texas, Utah,
   and South Carolina**
5. A short **description in your own words** of what you see in the numbers and the plot

\vspace{0.4em}
\normalsize
Full instructions: [project0 on the course site](https://jrm87.github.io/ECO3253_fall2026/project0.html#project0)

## Project 0: where to get help

- Everything you need is **on the course site** --- Getting Started, Data Visualization,
  Appendix A, and the Cheat Sheet
- **You may use generative AI.** Ask it to explain an error message, or to tell you what a
  line of code is doing
- Remember Tuesday: the students who lost out were the ones who used AI to *finish faster*.
  Use the time you save to actually understand the code
- You must be able to **explain any line you hand in** --- I may ask you in class

## Poll: did your PDF compile?

**A.** Yes --- compiled, ready to upload

**B.** It runs, but the PDF will not build

**C.** Not there yet --- stuck earlier

\vspace{0.5em}

\small A **poll**, not a quiz --- credit for answering. I want to know how many people to help
before tonight.

\vspace{0.3em}
\normalsize
**Upload your PDF on [Canvas](https://utsa.instructure.com/courses/92072/assignments/1391944) tonight by 11:59 pm.**
