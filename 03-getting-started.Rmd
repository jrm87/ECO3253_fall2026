...
- **install both on your own computer** --- this is what we will do, and both are free, or ...
- run them on someone else's computer (the cloud)

We will focus on the **local installation**, described just below. If you would rather work in
a browser, there is an optional note on [Posit Cloud](#posit-cloud-optional) further down ---
but it is your own free account, and **there is no class invite this semester**.
...
### Optional: Posit Cloud {#posit-cloud-optional}

If you would rather not install anything, [Posit Cloud](https://posit.cloud/) runs RStudio
inside your browser, and its **free tier** is enough for what we do in this course.

A few things to know before you go that route:

- It is **optional**. We work with the local installation in class, and that is what I support.
- **There is no class invite this semester** --- you sign up for your own free account.
- All the **code runs on someone else's computer**, in this case one owned by Posit.
- Either way, homework and projects are uploaded to Canvas as a PDF.
...
When you open RStudio, you should see a panel like the following:
...
Working locally, you install the packages you need yourself. Here is how. There are two ways to install an R package. For example, to install the `ggplot2` package:
