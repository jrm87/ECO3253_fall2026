...
- **Due**: At midnight on Thursday, October 22, 2026 [Canvas Link](https://utsa.instructure.com/courses/92072/assignments/1391947)
...
You can load the data directly from the class repository into R by running the following code:

```{r}
grade5 <- readRDS(gzcon(url("https://raw.githubusercontent.com/jrm87/ECO3253_fall2026/main/data/grade5.rds")))
```
...
You will work in RStudio for this project. Write the replication within a Quarto/RMarkdown file in the **project2** tab in Posit Cloud.
...
The file `grade5.rds`consist of n = 2,019 fifth grade classes at 1,002 public schools in Israel in 1991.  For more details on the construction of the variables included in this data set, please see [Angrist and Lavy (1999)](http://piketty.pse.ens.fr/files/AngristLavy1999.pdf).
