...
- **Due**: At midnight on Tuesday, March 10, 2026 [Canvas Link](https://utsa.instructure.com/courses/79928/assignments/1203158)
...
```{r}
grade5 <- readRDS(gzcon(url("https://raw.githubusercontent.com/jrm87/ECO3253_spring2026/main/data/grade5.rds")))
```
