...
- **Due**: Midnight on Thursday, November 19, 2026 [Canvas Link](https://utsa.instructure.com/courses/92072/assignments/1391948)
...
```{r eval=FALSE}
atlas_socialk <- readRDS(gzcon(url("https://raw.githubusercontent.com/jrm87/ECO3253_fall2026/main/data/atlas_socialk_tract.rds")))
```

## Instructions {-}

As usual, you will work in RStudio for this project. Write your responses within a [Quarto/RMarkdown here](#rmarkdown) file in the **project3** tab in Posit Cloud.
