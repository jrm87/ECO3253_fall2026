...
- **Due**: Midnight on Tuesday, April 14, 2026 [Canvas Link](https://utsa.instructure.com/courses/79928/assignments/1203200)
...
```{r eval=FALSE}
atlas_socialk <- readRDS(gzcon(url("https://raw.githubusercontent.com/jrm87/ECO3253_spring2026/main/data/atlas_socialk_tract.rds")))
```
